...
function tieneEmail (usuario) {
  ...
  // Tu código:
  const notValidatedOptions=[null,undefined]
  return !notValidatedOptions.includes(usuario.email)
}
...
function sumarLikesDeUsuario (usuario) {
  ...
  // Tu código:
  let likesTotales=0;
  const post=usuario.posts;
  post.forEach(post=>likesTotales+=post.likes);
  return likesTotales;
}
